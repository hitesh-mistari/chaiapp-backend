...
export async function sendPasswordResetEmail(email: string, resetToken: string): Promise<void> {
    ...
    const mailOptions = {
        from: `"ChaiTapri - CMS" <${process.env.GMAIL_USER}>`,
        to: email,
        subject: '🔒 Reset your ChaiTapri password',
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; line-height: 1.6;">
                ...
                <p>Hello,</p>
                <p>We received a request to reset your password for your <strong>ChaiTapri - CMS</strong> account.</p>
                ...
                <p style="color: #94a3b8; font-size: 12px; text-align: center;">🍵 ChaiTapri - CMS: Professional Shop Management</p>
            </div>
        `,
        text: `Reset your password for ChaiTapri - CMS: ${resetLink}`
    };
...
export async function sendVerificationEmail(email: string, token: string): Promise<void> {
    ...
    const mailOptions = {
        from: `"ChaiTapri - CMS" <${process.env.GMAIL_USER}>`,
        to: email,
        subject: '☘️ Verify your ChaiTapri Account',
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; line-height: 1.6;">
                <h2 style="color: #059669;">Welcome to ChaiTapri!</h2>
                <p>Hello,</p>
                <p>Thank you for joining <strong>ChaiTapri - CMS</strong>. Please verify your email address to activate your account and start managing your shop properly.</p>
                <div style="text-align: center; margin: 30px 0;">
                ...
                <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 20px 0;" />
                <p style="color: #94a3b8; font-size: 12px; text-align: center;">🍵 ChaiTapri - CMS: Smart management for small businesses</p>
            </div>
        `,
        text: `Verify your email for ChaiTapri - CMS: ${verificationLink}`
    };
